    ...
    <section class="relative">
      ...
      >
        <div class="flex flex-1 items-center gap-2.5 rounded-xl px-3 py-2">
          <i class="icon-[material-symbols--search] text-sm text-stone-400"></i>
          <input v-model="q" type="text" placeholder="¿Qué querés jugar?"
            class="h-8 w-full bg-transparent text-sm text-ink-500 outline-none placeholder:text-stone-400" />
        </div>
        <div class="hidden w-px bg-stone-100 lg:block"></div>
        <div class="flex flex-1 items-center gap-2.5 rounded-xl px-3 py-2">
          <i class="icon-[material-symbols--location-on] text-sm text-stone-400"></i>
        ...
        <div class="flex flex-1 items-center gap-2.5 rounded-xl px-3 py-2">
          ...
          <input v-model="fecha" type="date" :min="dayjs().format('YYYY-MM-DD')"
            class="h-8 w-full bg-transparent text-sm text-ink-500 outline-none" />
        </div>
        <div class="hidden w-px bg-stone-100 lg:block"></div>
        <div class="flex flex-1 items-center gap-2.5 rounded-xl px-3 py-2">
        ...
        <button type="submit"
          class="flex items-center justify-center gap-2 rounded-full bg-brand-lime-500 px-7 py-3 text-sm font-semibold text-brand-green-900 transition-colors hover:bg-brand-lime-600 cursor-pointer">
