    ...
    <div class="flex min-h-screen flex-col px-6 py-8 sm:px-12 lg:px-16">
      ...
      <div class="flex flex-1 flex-col justify-center py-10">
        <div class="mx-auto w-full max-w-md">
          <h1 class="text-3xl font-bold text-primitive-dark-500 sm:text-4xl">Iniciar sesión</h1>
          ...
          <form class="mt-7 space-y-5" @submit.prevent="handleSubmit">
            ...
            <div>
              ...
              <div class="relative">
                ...
                <button
                  type="button"
                  class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 transition-colors hover:text-slate-600 cursor-pointer"
            ...
            <div class="flex items-center justify-between">
              <label class="flex items-center gap-2 text-sm text-slate-600">
                <input type="checkbox" class="h-4 w-4 shrink-0 rounded border border-slate-300 bg-white accent-primitive-orange-500 [color-scheme:light]" />
                Recordarme
              </label>
              <a href="#" class="text-sm font-medium text-primitive-orange-500 hover:underline">¿Olvidaste tu contraseña?</a>
            </div>
